                ...
                <div className="grid lg:grid-cols-2">
                    ...
                    <div>
                        <div className="w-full px-4 pt-16">
                                    ...
                                    {({ open }) => (
                                        <>
                                            <Disclosure.Button className="flex w-full justify-between rounded-lg text-offwhite sm:px-4 sm:py-2 text-left md:text-2xl font-medium">
                                                <span>1. What is cryptocurrency?</span>
                                                <ChevronUpIcon
                            ...
                            <div className="mx-auto w-full max-w-5xl rounded-2xl bg-blue py-8 px-6 mb-5">
                                <Disclosure as="div" className="mt-2">
                                    {({ open }) => (
                                        <>
                                            <Disclosure.Button className="flex w-full justify-between rounded-lg text-offwhite sm:px-4 sm:py-2 text-left md:text-2xl font-medium">
                                                <span>2. Can cryptocurrency be converted to cash?</span>
                                                <ChevronUpIcon
                                                    className={`${open ? 'rotate-180 transform' : ''
                                                        } h-5 w-5 text-purple-500`}
                                                />
                            ...
                            <div className="mx-auto w-full max-w-5xl rounded-2xl bg-blue py-8 px-6">
                                <Disclosure as="div" className="mt-2">
                                    {({ open }) => (
                                        <>
                                            <Disclosure.Button className="flex w-full justify-between rounded-lg text-offwhite sm:px-4 sm:py-2 text-left md:text-2xl font-medium">
                                                <span>3. How long should you hold cryptocurrency?</span>
                                                <ChevronUpIcon
                                                    className={`${open ? 'rotate-180 transform' : ''
                                                        } h-5 w-5 text-purple-500`}
                                                />
